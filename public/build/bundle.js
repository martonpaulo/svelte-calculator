...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    var _CalculatorModel_value, _CalculatorModel_accumulator, _CalculatorModel_operation, _CalculatorModel_clearDisplay;
    ...
    class CalculatorModel {
        ...
        get value() {
            return __classPrivateFieldGet(this, _CalculatorModel_value, "f") || "0";
        }
        pressedNumber(newValue) {
            let resultValue;
            if (this.value === "0" || __classPrivateFieldGet(this, _CalculatorModel_clearDisplay, "f") || !__classPrivateFieldGet(this, _CalculatorModel_value, "f")) {
                resultValue = newValue;
            }
            else {
                resultValue = __classPrivateFieldGet(this, _CalculatorModel_value, "f") + newValue;
            }
            return new CalculatorModel(resultValue, __classPrivateFieldGet(this, _CalculatorModel_accumulator, "f"), __classPrivateFieldGet(this, _CalculatorModel_operation, "f"), DO_NOT_CLEAR_DISPLAY);
        }
        pressedDecimal() {
            var _a;
            return new CalculatorModel(((_a = __classPrivateFieldGet(this, _CalculatorModel_value, "f")) === null || _a === void 0 ? void 0 : _a.includes(".")) ? __classPrivateFieldGet(this, _CalculatorModel_value, "f") : __classPrivateFieldGet(this, _CalculatorModel_value, "f") + ".", __classPrivateFieldGet(this, _CalculatorModel_accumulator, "f"), __classPrivateFieldGet(this, _CalculatorModel_operation, "f"), DO_NOT_CLEAR_DISPLAY);
        }
        pressedClear() {
            return new CalculatorModel();
        }
        ...
        calculate(nextOperation = null) {
            ...
            const resultValue = !__classPrivateFieldGet(this, _CalculatorModel_operation, "f") ? __classPrivateFieldGet(this, _CalculatorModel_value, "f") : `${accumulator}`;
            return new CalculatorModel(resultValue, accumulator, nextOperation, nextOperation ? CLEAR_DISPLAY : DO_NOT_CLEAR_DISPLAY);
        }
    }
    _CalculatorModel_value = new WeakMap(), _CalculatorModel_accumulator = new WeakMap(), _CalculatorModel_operation = new WeakMap(), _CalculatorModel_clearDisplay = new WeakMap();
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*text*/ ctx[0]);
    			attr_dev(button, "class", "button svelte-1ykrll6");
    			...
    			toggle_class(button, "tertiary", /*tertiary*/ ctx[4]);
    			add_location(button, file$4, 8, 0, 191);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['text', 'double', 'triple', 'secondary', 'tertiary', 'onClick'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('tertiary' in $$props) $$invalidate(4, tertiary = $$props.tertiary);
    	...
    	return [text, double, triple, secondary, tertiary, onClick, click_handler];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(/*value*/ ctx[0]);
    			add_location(span, file$3, 20, 2, 371);
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(`display ${/*fontSize*/ ctx[1]}`) + " svelte-1ggkdiv"));
    			add_location(div, file$3, 19, 0, 333);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*fontSize*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(`display ${/*fontSize*/ ctx[1]}`) + " svelte-1ggkdiv"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (value === undefined && !('value' in $$props || $$self.$$.bound[$$self.$$.props['value']])) {
    			console.warn("<Display> was created without expected prop 'value'");
    		}
    	});
    	...
    	$$self.$capture_state = () => ({ value, fontSize });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*value*/ 1) {
    			if (value.length < 8) {
    				$$invalidate(1, fontSize = "big");
    			} else if (value.length < 13) {
    				$$invalidate(1, fontSize = "big-medium");
    			} else if (value.length < 18) {
    				$$invalidate(1, fontSize = "medium");
    			} else if (value.length < 23) {
    				$$invalidate(1, fontSize = "medium-small");
    			} else {
    				$$invalidate(1, fontSize = "small");
    			}
    		}
    	};
    ...
    const file$2 = "src/components/Row.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "row svelte-10dw15q");
    ...
    /* src/components/Calculator.svelte generated by Svelte v3.58.0 */
    ...
    function create_default_slot_4(ctx) {
    	...
    	button1 = new Button({
    			props: {
    				tertiary: true,
    				text: "/",
    				onClick: /*pressedOperation*/ ctx[2]
    			},
    			$$inline: true
    		});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "calculator svelte-z4wk1m");
    			add_location(div, file$1, 12, 0, 532);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const pressedNumber = num => $$invalidate(0, calc = calc.pressedNumber(num));
    	const pressedOperation = op => $$invalidate(0, calc = calc.pressedOperation(op));
    	const pressedDecimal = () => $$invalidate(0, calc = calc.pressedDecimal());
    	const pressedClear = () => $$invalidate(0, calc = calc.pressedClear());
    	...
    	return [calc, pressedNumber, pressedOperation, pressedDecimal, pressedClear, calculate];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1szizkl");
